...
class Payment(models.Model):
    ...
    physician_profile_id = models.IntegerField(null=True)
    physician_npi = models.IntegerField(null=True)
    physician_first_name = models.CharField(max_length=50, null=True)
    physician_middle_name = models.CharField(max_length=50, null=True)
    physician_last_name = models.CharField(max_length=50, null=True)
    physician_name_suffix = models.CharField(max_length=10, null=True)
    physician_primary_type = models.CharField(max_length=50, null=True)
    physician_specialty = models.CharField(max_length=100, null=True)
    physician_license_state_code1 = models.CharField(max_length=2, null=True)
    physician_license_state_code2 = models.CharField(max_length=2, null=True)
    physician_license_state_code3 = models.CharField(max_length=2, null=True)
    physician_license_state_code4 = models.CharField(max_length=2, null=True)
    physician_license_state_code5 = models.CharField(max_length=2, null=True)

    product_indicator = models.CharField(max_length=50, null=True)
    name_of_associated_covered_drug_or_biological1 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_drug_or_biological2 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_drug_or_biological3 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_drug_or_biological4 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_drug_or_biological5 = models.CharField(max_length=100, null=True)
    ndc_of_associated_covered_drug_or_biological1 = models.CharField(max_length=100, null=True)
    ndc_of_associated_covered_drug_or_biological2 = models.CharField(max_length=100, null=True)
    ndc_of_associated_covered_drug_or_biological3 = models.CharField(max_length=100, null=True)
    ndc_of_associated_covered_drug_or_biological4 = models.CharField(max_length=100, null=True)
    ndc_of_associated_covered_drug_or_biological5 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_device_or_medical_supply1 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_device_or_medical_supply2 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_device_or_medical_supply3 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_device_or_medical_supply4 = models.CharField(max_length=100, null=True)
    name_of_associated_covered_device_or_medical_supply5 = models.CharField(max_length=100, null=True)
